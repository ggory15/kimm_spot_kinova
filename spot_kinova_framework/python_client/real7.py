...
class ControlSuiteShell(cmd.Cmd):
    ...
    def __init__(self):
        ...
        self.tray_qr5_to_plant1_x = -0.077 #-0.075
        self.tray_qr5_to_plant1_y =  0.075
        self.tray_qr5_to_plant2_x = -0.075   
        self.tray_qr5_to_plant2_y = -0.07#-0.065

        self.table1_qr3_to_plant1_x = -0.075 #-0.08
        self.table1_qr3_to_plant1_y =  0.075 #0.065
        self.table1_qr3_to_plant2_x = -0.075#-0.08
        self.table1_qr3_to_plant2_y = -0.07#-0.07
    ...
    def do_qrplant1pick_fromtable1(self, arg):
        ...
        goal.target_pose.position.z    =  self.gripper_length + 0.02#0.035
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_qrtray1plantapproach(self, arg):
        ...
        goal.target_pose.position.z    =  self.gripper_length + 0.02#0.04
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_test_tray_place(self, arg):    
        ...
        # if (self.issucceed):
        #     self.do_armright(150)               #go to tray palce location
        # if (self.issucceed):
    ...
    def do_test_plant2_table_to_tray(self, arg):    
        ...
        if (self.issucceed):
            self.do_position(70)                   #grasp the plant                      
        if (self.issucceed):
            self.do_armup(150)                     #pick up the plant
        if (self.issucceed):
