...
class ControlSuiteShell(cmd.Cmd):
    ...
    def __init__(self):
        ...
        self.box_qr2_to_grasp_x = 0.01
        self.box_qr2_to_grasp_y = -0.068                                                  

        self.tray_qr5_to_grasp_x =  -0.005
        self.tray_qr5_to_grasp_y =  -0.052
        self.tray_qr5_to_plant1_x = -0.075
        self.tray_qr5_to_plant1_y =  0.075
        self.tray_qr5_to_plant2_x = -0.075   
        self.tray_qr5_to_plant2_y = -0.065

        self.table1_qr3_to_plant1_x = -0.08
        self.table1_qr3_to_plant1_y =  0.065
        self.table1_qr3_to_plant2_x = -0.08
        self.table1_qr3_to_plant2_y = -0.07

        self.table2_qr4_to_plant1_x = -0.065
        self.table2_qr4_to_plant1_y =  0.075
        self.table2_qr4_to_plant2_x = -0.065
        self.table2_qr4_to_plant2_y = -0.07

        self.pick_z_offset =  0.025
        self.place_z_offset =  0.06        
    ...
    def do_qrplant1pick_fromtable1(self, arg):
        ...
        goal.target_pose.position.x    =                        self.table1_qr3_to_plant1_x  
        goal.target_pose.position.y    =                        self.table1_qr3_to_plant1_y
        goal.target_pose.position.z    =  self.gripper_length + 0.035
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_qrtray1plantapproach(self, arg):
        ...
        goal.target_pose.position.z    =  self.gripper_length + 0.04
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_qrplant2pick_fromtable1(self, arg):
        ...
        goal.target_pose.position.x    =                        self.table1_qr3_to_plant2_x  
    ...
    def do_qrplant1pick_fromtray(self, arg):
        ...
        goal.target_pose.position.x    =                        self.tray_qr5_to_plant1_x
        goal.target_pose.position.y    =                        self.tray_qr5_to_plant1_y
        goal.target_pose.position.z    =  self.gripper_length + self.pick_z_offset
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_qrtable1plantapproach(self, arg):
        ...
        goal.target_pose.position.z    =  self.gripper_length + self.place_z_offset  
        goal.target_pose.orientation.x =  0.0
        goal.target_pose.orientation.y =  0.0
        goal.target_pose.orientation.z =  0.0
        goal.target_pose.orientation.w =  1.0        
    ...
    def do_test_tray_place(self, arg):    
        ...
        if (self.issucceed):
            self.do_armforward(250)               #go to tray palce location
        if (self.issucceed):
            self.do_armdown(70)               #go to tray palce location
        if (self.issucceed):
            self.do_position(85)                    #place the tray              
        if (self.issucceed):
    ...
    def do_test_plant1_table_to_tray(self, arg):    
        ...
        if (self.issucceed):
            ...
            self.do_qr5save(arg)                   #save qr5 pose           
        if (self.issucceed):
            self.do_armleft(150)                   #go left to see table#2 qr (qr4)
        if (self.issucceed):
            time.sleep(3)                          #wait before qr recognition
            self.do_qr3save(arg)                   #save qr5 pose           
        if (self.issucceed):
            self.do_position(50)                   #half close gripper before approching to the plant
        if (self.issucceed):
