...
CTRL-C to quit
    ...
    def joy_callback(self, data):
        ...
        body_pose_lite.x = 0
        body_pose_lite.y = 0
        body_pose_lite.roll = (data.axes[2]) * 0.349066
        body_pose_lite.pitch = (data.axes[5]) * 0.174533

        # if data.buttons[5]:
        #     body_pose_lite.roll = (32767-data.axes[3]) * 0.349066
        # else:
        #     body_pose_lite.roll = -(32767-data.axes[3]) * 0.349066
        
        # # body_pose_lite.roll = (data.buttons[5]) *(32767-data.axes[3]) * 0.349066
        # body_pose_lite.pitch = data.axes[4] * 0.174533
        # body_pose_lite.yaw = data.buttons[5] * data.axes[3] * 0.436332
        if data.axes[5] < 0 and data.buttons[5]:
